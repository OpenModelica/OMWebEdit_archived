...
export class OMWebEditDefaultNodeFactory extends AbstractReactFactory<
  OMWebEditDefaultNodeModel,
  DiagramEngine
> {
  constructor() {
  ...
  generateReactWidget(event): JSX.Element {
    return (
      <OMWebEditNodeWidget engine={this.engine} size={100} node={event.model} />
    );
  }
